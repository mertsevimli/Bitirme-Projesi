...
using static Iyzipay.Model.Payment;
...
public class CartController : Controller
{
        ...
        string DeliveryAddress, string BillingAddress)
    {
        ...
        buyer.Country = teslimatAdresi.City; //"Turkey";
        buyer.ZipCode = "34732";
        request.Buyer = buyer;
        ...
        shippingAddress.Country = teslimatAdresi.City; //"Turkey";
        ...
        billingAddress.Country = faturaAdresi.City;// "Turkey";
        ...
        Payment payment = await Create(request, options);
        ...
        try
        {
            if (payment.Status == "success")
            {
                ...
                {
                    TempData["Message"] = " <div class 'alert alert-danger'>Ödeme işlemi başarısız!</div>";
                }
                // Sipariş Oluştur
            }
        }
